...
https://www.tinkercad.com/things/0dwzKWmo3Hw-233cd4511-ile-0-99-butonlu-sayac-yapimi-ileri-geri/editel
...
void setup()
{
  ...
  pinMode(D5,INPUT);//4. pini giriş olarak atıyoruz
  Serial.begin(9600);
}
void loop()
{
  ...
  if(digitalRead(D4)==LOW)//eger 5 pin LOW ise
  {
    iSayac--;
    saydir();
    delay(300);
